    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests((req) -> req
                ...
                .requestMatchers("/product/rcon").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
                .requestMatchers("/product/api").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
                .requestMatchers("/product/key").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
                .requestMatchers("/product/key/names").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
                .requestMatchers("/product/secret").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
                // ===
                .requestMatchers(HttpMethod.PUT, "/file/*").hasAuthority(UserEntity.UserRole.BUSINESS.getAuthority())
